	...
	<div class="container">
		<section id="gallery">
			@if(!empty($pesanan))
				...
				<div class="row">
						...
						<table class="table table-responsive-md">
							...
							<tbody class="align-middle">
								...
								<tr align="left">
									...
									<td><img src="{{ asset('assets') }}/img/product/{{ $detailPesanan->produk->gambar }}" alt="{{ $detailPesanan->produk->gambar }}" width="75px"> </td>
					...
					<div class="col-md-12">
						<div class="pull-left text-start">
							<span>Tanggal pesanan : {{ $pesanan->tgl_pesan  }}</span>
						</div>
				...
				@else
				<h2>Belum Ada Pesanan Masuk Keranjang</h2>
			@endif 
		</section>
	</div>

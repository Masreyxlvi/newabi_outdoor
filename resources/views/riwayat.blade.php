...
@section('main')
					...
					<table class="table table-responsive-md">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{ $pesanan->batas_waktu }}</td>
								<td>
									<button type="button" class="btn btn-outline-success btn-sm" data-bs-toggle="modal" data-bs-target="#detail{{ $key }}">
										<i class="bi bi-cart3"></i>
									</button>	
									<a href="/faktur/{{ $pesanan->kode_pesanan }}" class="btn btn-outline-danger btn-sm"><i class="bi bi-printer"></i></a>								
								</td>
							</tr>
							@endforeach
						</tbody>
	...
	@foreach ($pesanans as $key => $pesanan)
		<div class="modal fade" id="detail{{ $key }}" tabindex="-1" aria-labelledby="detailLabel" aria-hidden="true">
